...
// NB: Based on subset of master-8 and pulse-pal parameters. See this page for a
// visual definition:
...
enum oe_estim_regs {
    ...
    OE_ESTIM_BURSTDUR    = 8,  // Burst duration, microseconds
    OE_ESTIM_IBI         = 9,  // Inter-burst interval, microseconds
    OE_ESTIM_TRAINDUR    = 10, // Pulse train duration, microseconds
    OE_ESTIM_TRAINDELAY  = 11, // Pulse train delay, microseconds
    OE_ESTIM_TRIGGER     = 12, // Trigger stimulation (1 = deliver)
    OE_ESTIM_POWERON     = 13, // Turn estim power on (0 = off, 1 = on)
};
