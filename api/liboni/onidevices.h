...
typedef enum oni_device_id {
    ...
    ONI_FMCCLKIN1R4          = 19,  // Open Ephys FMC Host Board rev. 1.4 clock intput subcircuit
    ONI_FMCCLKOUT1R4         = 20,  // Open Ephys FMC Host Board rev. 1.4 clock output subcircuit
