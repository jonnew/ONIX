...
typedef enum oni_device_id {
    ...
    ONI_TEST0                = 10,  // Test device
    ONI_NEUROPIX1R0          = 11,  // Neuropixels 6B device
    ONI_HEARTBEAT            = 12,  // Host heartbeat
    ONI_AD51X2_ID            = 13,  // AD51X2 digital potentiometer
    ONI_FMCVCTRL_ID          = 14,  // Open Ephys FMC Host Board rev. 1.3 link voltage controller
    ONI_AD7617_ID            = 15,  // AD7617 ADC/DAS
